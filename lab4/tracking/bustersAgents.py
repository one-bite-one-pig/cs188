...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        ghost_pos=None
        for single_distribution in livingGhostPositionDistributions:
            max_possible=0
            max_pos=None
            for pos in single_distribution:
                if single_distribution[pos]>max_possible:
                    max_possible=single_distribution[pos]
                    max_pos=pos
            cur_distance=self.distancer.getDistance(pacmanPosition,max_pos)
        ...
        for action in legal:
            ...
            d=self.distancer.getDistance(successorPosition,ghost_pos)
            if d< min_dis:
                min_dis=d
                best_action=action
